...
<nav class="navbar navbar-inverse">
  ...
  <ul class="dropdown-menu">
   ...
   <div class="container-fluid"> 
   <table><tr><td>
	<h3>&emsp;Room Records | Deluxe Rooms&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
	&emsp;&emsp;&emsp;&emsp;
	</h3>
	</td>
	<td>
	<form action="DBDeluxe.php" method="POST">
	<input type="text" name="search" size=30> 
	<button type="submit" class="btn btn-default"  onclick="location='DBDeluxe.php' ">
      <span class="glyphicon glyphicon-search"></span> Search
	<button type="button" class="btn btn-default"  onclick="location='DBDeluxe.php' " >
...
WHERE 
fldtype = '".$deluxe."' && fldcustomer LIKE '%".$search."%' && fldreservation = '".$available."' || 
fldtype = '".$deluxe."' && fldrate LIKE '%".$search."%' && fldreservation = '".$available."' 
 ");

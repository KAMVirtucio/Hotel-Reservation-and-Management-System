...
$pdf->SetTitle('SolaCrest - Hotel Management Information System');
...
$pdf->Cell(0, 12, 'List of Customer Reservation Summary Report', 0, 1, '');
...
$tbl_header = '<table border="2" cellpadding="3">';

$tbl_footer = '</table>';
$tbl ='';
$tbl1 ='';

$tbl1 .= '<tr style="background-color:#a3952f;color:#FFFFFF;"><td width="95">' . "Room No." .  '</td><td width="95">' . "Room Type" . '</td><td width="95">' . "First Name" . '</td><td width="95">' . "Last Name" . '</td><td width="95">' .  "Arrival Date" . '</td><td width="95">'  . "Department Date" . '</td><td width="95">' . "Number of Persons" . '</td><td width="95">' .  "Total Cost" . '</td></tr>';

...
<nav class="navbar navbar-inverse">
  ...
  <ul class="dropdown-menu">
   ...
   <div class="container-fluid"> 
   <table><tr><td>
	<h3>&emsp;Room Control | Signature Deluxe Room&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
	</h3>
	</td>
	<td> 
	<form action="ControlDBSignature.php" method="POST">
	<input type="text" name="search" size=30> 
	<button type="submit" class="btn btn-default"  onclick="location='ControlDBSignature.php' ">
...
<form action="InsertDBSignature2.php" method="POST">  
  ...
  Status: &emsp;&emsp;&nbsp;<input type="text" name="reservation" /></br></br>
   ...
   Room Type: <input type="text" name="roomtype" /></br></br>
	...
	<a href="ControlDBSignature.php"><button class="btn btn-danger">Cancel</button></a>

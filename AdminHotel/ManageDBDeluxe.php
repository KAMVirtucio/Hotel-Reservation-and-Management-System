...
<nav class="navbar navbar-inverse">
  ...
  <ul class="dropdown-menu">
   ...
   <div class="container-fluid"> 
   <table><tr><td>
	<h3>&emsp;Room Management | Deluxe Rooms&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
	</h3>
	</td>
	<td>
	<form action="ManageDBDeluxe.php" method="POST">
	<input type="text" name="search" size=30> 
	<button type="submit" class="btn btn-default"  onclick="location='ManageDBDeluxe.php' ">
      <span class="glyphicon glyphicon-search"></span> Search
	<button type="button" class="btn btn-default"  onclick="location='ManageDBDeluxe.php' " >
...
WHERE 
fldtype = '".$deluxe."' && fldcustomer LIKE '%".$search."%' && fldreservation = '".$reserved."' || 
fldtype = '".$deluxe."' && fldrate LIKE '%".$search."%' && fldreservation = '".$reserved."' ||
fldtype = '".$deluxe."' && lname LIKE '%".$search."%' && fldreservation = '".$reserved."'
 ");
...
while($row = mysql_fetch_array($result))
{
	...
	?>
<form action='LeaveDeluxe.php' method='POST'>

...
<nav class="navbar navbar-inverse">
  ...
  <ul class="dropdown-menu">
   ...
   <div class="container-fluid"> 
   <table><tr><td>
	<h3>&emsp;Room Control | Signature Deluxe Rooms&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
	</h3>
	</td>
	<td>
	<form action="ControlDBSignature.php" method="POST">
	<input type="text" name="search" size=30> 
	<button type="submit" class="btn btn-default"  onclick="location='ControlDSignature.php' ">
      <span class="glyphicon glyphicon-search"></span> Search
	<button type="button" class="btn btn-default"  onclick="location='ControlDBSignature.php' " >
      <span class="glyphicon glyphicon-eye-open"></span> View All
    </button>
	<button type="button" class="btn btn-default"  onclick="location='InsertDBSignature.php' " >
	  ...
	  <th>ROOM TYPE</th>
	  <th>STATUS</th>
	  <th colspan=2>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;CONTENT CONTROL</th>
	  </tr>
	  </thead>
	  <tbody>
	  <tr class="active">
...
WHERE 
fldtype = '".$sdeluxe."' &&  fldreservation='".$available."' && fldcustomer LIKE '%".$search."%'|| 
fldtype = '".$sdeluxe."' &&  fldreservation='".$available."' && fldrate LIKE '%".$search."%'");
...
while($row = mysql_fetch_array($result))
{
	...
	echo "<form action='SignatureEditRoom.php' method='POST'><input type = 'hidden' name = 'roomno' value='" . $row['fldcustomer'] . "'>";
	...
	<form action="DeleteSignatureRoom.php" method="POST">

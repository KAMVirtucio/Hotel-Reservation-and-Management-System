...
<nav class="navbar navbar-inverse">
  ...
  <ul class="dropdown-menu">
   ...
   <div class="container-fluid"> 
   <table><tr><td>
	<h3>&emsp;Room Control | Signature Deluxe Room&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
	</h3>
	</td>
	<td> 
...
{
?>
	<form action='SignatureEditRoom2.php' method='POST'>
	<tr>
	<td align = center>
...
if($flag==0 && $flag2<2)
{
	include "include/conn.php";
		...
		<center><button class="btn btn-success" onclick="window.location='ControlDBSignature.php'">Go Back</button></center>
		</td>
		</tr>

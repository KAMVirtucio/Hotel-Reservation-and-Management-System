...
<nav class="navbar navbar-inverse">
  ...
  <ul class="dropdown-menu">
   ...
   <div class="container-fluid"> 
   <table><tr><td>
	<h3>&emsp;Room Management | Signature Deluxe Room &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
	</h3>
	</td>
	<td>
...
fldreservation='" . $available . "',lname='" . $lname . "', fstart='" . $arrival. "',  fend='" . $departure . "', fbill='" . $rate. "', fname='" . $fname. "', fpersons='" . $persons. "' WHERE fldcustomer='" . $ref . "'");
		...
		<a href="ManageDBSignature.php"><button type="button" class="btn btn-success">Go Back</button></a>

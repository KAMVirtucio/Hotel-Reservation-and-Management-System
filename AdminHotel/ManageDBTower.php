...
<nav class="navbar navbar-inverse">
  ...
  <ul class="dropdown-menu">
   ...
   <div class="container-fluid"> 
   <table><tr><td>
	<h3>&emsp;Room Management | Tower Deluxe Rooms&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
	</h3>
	</td>
	<td>
	<form action="ManageDBTower.php" method="POST">
	<input type="text" name="search" size=30> 
	<button type="submit" class="btn btn-default"  onclick="location='ManageDBTower.php' ">
      <span class="glyphicon glyphicon-search"></span> Search
	<button type="button" class="btn btn-default"  onclick="location='ManageDBTower.php' " >
...
$tdeluxe = "tower deluxe";
$reserved = "Reserved";
$result = mysql_query("SELECT * FROM tblhotel  

WHERE 
fldtype = '".$tdeluxe."' && fldcustomer LIKE '%".$search."%' && fldreservation = '".$reserved."' || 
fldtype = '".$tdeluxe."' && fldrate LIKE '%".$search."%' && fldreservation = '".$reserved."' ||
fldtype = '".$tdeluxe."' && lname LIKE '%".$search."%' && fldreservation = '".$reserved."'
 ");
...
while($row = mysql_fetch_array($result))
{
	...
	?>
<form action='LeaveTower.php' method='POST'>

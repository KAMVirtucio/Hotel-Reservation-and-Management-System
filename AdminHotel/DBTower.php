...
<nav class="navbar navbar-inverse">
  ...
  <ul class="dropdown-menu">
   ...
   <div class="container-fluid"> 
   <table><tr><td>
	<h3>&emsp;Room Records | Tower Deluxe Rooms &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
	&emsp;&emsp;
	</h3>
	</td>
	<td>
	<form action="DBTower.php" method="POST">
	<input type="text" name="search" size=30> 
	<button type="submit" class="btn btn-default"  onclick="location='DBTower.php' ">
      <span class="glyphicon glyphicon-search"></span> Search
	<button type="button" class="btn btn-default"  onclick="location='DBTower.php' " >
...
WHERE 
fldtype = '".$tdeluxe."' && fldcustomer LIKE '%".$search."%' && fldreservation = '".$available."' || 
fldtype = '".$tdeluxe."' && fldrate LIKE '%".$search."%' && fldreservation = '".$available."' ");

...
<nav class="navbar navbar-inverse">
  ...
  <ul class="dropdown-menu">
   ...
   <div class="container-fluid"> 
   <table><tr><td>
	<h3>&emsp;Room Control | Deluxe Rooms&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
	</h3>
	</td>
	<td>
...
WHERE 
fldtype = '".$deluxe."' &&  fldreservation='".$available."'  && fldcustomer LIKE '%".$search."%'|| 
fldtype = '".$deluxe."' &&  fldreservation='".$available."'  && fldrate LIKE '%".$search."%'");
...
while($row = mysql_fetch_array($result))
{
	...
	echo "<form action='DeluxeEditRoom.php' method='POST'><input type = 'hidden' name = 'roomno' value='" . $row['fldcustomer'] . "'>";
	
	?>
	<td><button type="submit" class="btn btn-success">UPDATE</button> </td>
		</form>	
	<form action="DeleteDeluxeRoom.php" method="POST">

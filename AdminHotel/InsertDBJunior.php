...
<nav class="navbar navbar-inverse">
  ...
  <ul class="dropdown-menu">
   ...
   <div class="container-fluid"> 
   <table><tr><td>
	<h3>&emsp;Room Control | Junior Suite&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
	</h3>
	</td>
	<td> 
	<form action="ControlDBJunior.php" method="POST">
	<input type="text" name="search" size=30> 
	<button type="submit" class="btn btn-default"  onclick="location='ControlDBJunior.php' ">
...
<form action="InsertDBJunior2.php" method="POST">  
  Room No: <input type="text" name="guest"  /></br></br>
  
  Room Rate: <input type="text" name="roomrate" /></br></br>

  Status: &emsp;&emsp;&nbsp;<input type="text" name="reservation" /></br></br>
  
   Room Type: <input type="text" name="roomtype" /></br></br>

</br>&nbsp;<button class="btn btn-success" type="submit">Insert</button></br></br>
</form>
	<a href="ControlDBJunior.php"><button class="btn btn-danger">Cancel</button></a>

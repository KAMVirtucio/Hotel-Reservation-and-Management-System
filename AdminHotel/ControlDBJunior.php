...
<nav class="navbar navbar-inverse">
  ...
  <ul class="dropdown-menu">
   ...
   <div class="container-fluid"> 
   <table><tr><td>
	<h3>&emsp;Room Control | Junior Suite&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
	</h3>
	</td>
	<td>
	<form action="ControlDBJunior.php" method="POST">
	<input type="text" name="search" size=30> 
	<button type="submit" class="btn btn-default"  onclick="location='ControlDJunior.php' ">
      <span class="glyphicon glyphicon-search"></span> Search
	<button type="button" class="btn btn-default"  onclick="location='ControlDBJunior.php' " >
      <span class="glyphicon glyphicon-eye-open"></span> View All
    </button>
	<button type="button" class="btn btn-default"  onclick="location='InsertDBJunior.php' " >
...
WHERE 
fldtype = '".$junior."' &&  fldreservation='".$available."' && fldcustomer LIKE '%".$search."%'|| 
fldtype = '".$junior."' &&  fldreservation='".$available."' && fldrate LIKE '%".$search."%'");
...
while($row = mysql_fetch_array($result))
{
	...
	echo "<form action='JuniorEditRoom.php' method='POST'><input type = 'hidden' name = 'roomno' value='" . $row['fldcustomer'] . "'>";
	...
	<form action="DeleteJuniorRoom.php" method="POST">

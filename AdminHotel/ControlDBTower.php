...
<nav class="navbar navbar-inverse">
  ...
  <ul class="dropdown-menu">
   ...
   <div class="container-fluid"> 
   <table><tr><td>
	<h3>&emsp;Room Control | Tower Deluxe Rooms&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
	</h3>
	</td>
	<td>
	<form action="ControlDBTower.php" method="POST">
	<input type="text" name="search" size=30> 
	<button type="submit" class="btn btn-default"  onclick="location='ControlDTower.php' ">
...
WHERE 
fldtype = '".$tdeluxe."' &&  fldreservation='".$available."' && fldcustomer LIKE '%".$search."%'|| 
fldtype = '".$tdeluxe."' &&  fldreservation='".$available."' && fldrate LIKE '%".$search."%'");
...
while($row = mysql_fetch_array($result))
{
	...
	?>
	<form action='TowerEditRoom.php' method='POST'>
	<input type = 'hidden' name = 'roomno' value="<?php echo $row['fldcustomer'] ?>">
	<td><button type="submit" class="btn btn-success">UPDATE</button> </td>
		</form>	
	<form action="DeleteTowerRoom.php" method="POST">
	<input type = 'hidden' name = 'roomno' value="<?php echo $row['fldcustomer'] ?>">

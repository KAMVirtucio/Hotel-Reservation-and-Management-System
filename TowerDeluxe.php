...
<div class="jumbotron">
	<div class="container">
		<div class="row setup-content" id="ProfileSetup-step">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<font color="#a3952f"><p> Tower Deluxe Room</p></font>    
  ...
  <div class="carousel-inner">
    <div class="item active">
     <img src="TDeluxe.jpg" style="width:560px;height:350px">
    </div>

    <div class="item">
     <img src="TDeluxe2.jpg" style="width:560px;height:350px">
    </div>

    <div class="item">
      <img src="TDeluxe3.jpg" style="width:560px;height:350px">
    </div>
  </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style= "background-color: #a3952f" >
          ...
          <h4 class="modal-title">Tower Deluxe Room has:</h4>
        </div>
...
<tr>
<th>
<font color = white size = 5><center>Availabe Rooms: Tower Deluxe Room</center>
</th>
</tr>
</table>
...
WHERE 
fldtype = '".$tdeluxe."' && fldreservation = '".$available."' || 
fldtype = '".$tdeluxe."' && fldreservation = '".$available."' 
 ");

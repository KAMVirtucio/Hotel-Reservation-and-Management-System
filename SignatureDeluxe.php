...
<div class="jumbotron">
	<div class="container">
		<div class="row setup-content" id="ProfileSetup-step">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<font color="#a3952f"><p> Signature Deluxe Room</p></font>    
  ...
  <div class="carousel-inner">
    <div class="item active">
     <img src="SDeluxe.jpg" style="width:560px;height:350px">
    </div>

    <div class="item">
    <img src="SDeluxe2.jpg" style="width:560px;height:350px">
    </div>

    <div class="item">
     <img src="SDeluxe3.jpg" style="width:560px;height:350px">
    </div>
  </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style= "background-color: #a3952f" >
          ...
          <h4 class="modal-title">Signature Deluxe Room has:</h4>
        </div>
        <div class="modal-body">
		 <ul>
	  <li>1 King Size Bed or 2 Queen Beds</li>
...
<tr>
<th>
<font color = white size = 5><center>Availabe Rooms: Signature Deluxe Room</center>
</th>
</tr>
</table>
...
$available = "Available";
$result = mysql_query("SELECT * FROM tblhotel  WHERE 
fldtype = '".$sdeluxe."' && fldreservation = '".$available."' || 
fldtype = '".$sdeluxe."' && fldreservation = '".$available."'");

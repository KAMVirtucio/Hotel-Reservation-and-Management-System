...
<div class="jumbotron">
	<div class="container">
		<div class="row setup-content" id="ProfileSetup-step">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<font color="#a3952f"><p> Junior Sute</p></font>    
  ...
  <div class="carousel-inner">
    ...
    <img src="Junior.jpg" style="width:560px;height:350px">
    </div>

    <div class="item">
    <img src="Junior2.jpg" style="width:560px;height:350px">
    </div>

    <div class="item">
      <img src="Junior3.jpg" style="width:560px;height:350px">
    </div>
  </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style= "background-color: #a3952f" >
          ...
          <h4 class="modal-title">Junior Suite has:</h4>
        </div>
...
<tr>
<th>
<font color = white size = 5><center>Availabe Rooms: Junior Suite</center>
</th>
</tr>
</table>
...
WHERE 
fldtype = '".$junior."' && fldreservation = '".$available."' || 
fldtype = '".$junior."' && fldreservation = '".$available."' ");
